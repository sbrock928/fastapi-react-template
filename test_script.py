...
def test_query_builder():
    ...
    try:
        ...
        from app.query import QueryBuilder, QueryParameters, CalculationDefinition, DealTrancheFilter, AggregationLevel, FieldType
...
def test_query_engine_compatibility():
    ...
    try:
        ...
        from app.query import QueryParameters, CalculationDefinition, DealTrancheFilter, AggregationLevel, FieldType
...
def test_identical_preview_execution():
    ...
    try:
        ...
        if execution_sql == preview_sql:
            ...
            print("Execution SQL:", execution_sql[:200] + "..." if len(execution_sql) > 200 else execution_sql)
            print("Preview SQL:", preview_sql[:200] + "..." if len(preview_sql) > 200 else preview_sql)
            return False
