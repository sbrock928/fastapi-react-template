...
async def update_employee(employee_id: int, employee_data: EmployeeUpdate, service=Depends(get_employee_service)):
    """Update an employee"""
...
@router.get("/employees/by-department/{department}", response_model=List[EmployeeRead], tags=["Employees"])
...
@router.get("/employees/by-position/{position}", response_model=List[EmployeeRead], tags=["Employees"])
...
async def create_subscriber(subscriber_data: SubscriberCreate, service=Depends(get_subscriber_service)):
...
async def update_subscriber(subscriber_id: int, subscriber_data: SubscriberUpdate, service=Depends(get_subscriber_service)):
    """Update a subscriber"""
...
@router.get("/subscribers/by-tier/{tier}", response_model=List[SubscriberRead], tags=["Subscribers"])
