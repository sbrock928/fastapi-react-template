...
const ColumnManagement: React.FC<ColumnManagementProps> = ({
  ...
  // Toggle default columns inclusion
  const toggleDefaultColumns = () => {
    updatePreferences({
      ...preferences,
      include_default_columns: !preferences.include_default_columns
    });
  };
    ...
    <div className="column-management">
        ...
        <div className="card-body py-2">
          <div className="form-check">
            <input
              ...
              type="checkbox"
              id="includeDefaults"
              checked={preferences.include_default_columns}
              onChange={toggleDefaultColumns}
            />
            <label className="form-check-label" htmlFor="includeDefaults">
              <strong>Include default columns</strong> (Deal Number, {reportScope === 'TRANCHE' ? 'Tranche ID, ' : ''}Cycle Code)
            </label>
          </div>
          <small className="text-muted">
            These columns are automatically generated by the backend and contain essential identifiers.
          </small>
        </div>
      </div>
      ...
      <div className="mt-3 p-3 bg-light rounded">
        <div className="row text-center">
          ...
          <div className="col-4">
            <strong>{preferences.include_default_columns ? 'Yes' : 'No'}</strong>
            <br />
            <small className="text-muted">Default Columns</small>
          </div>
        </div>
      </div>
